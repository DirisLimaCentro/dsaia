...
{
	*/
require_once "../modelos/Ficha6SanAlimentacion.php";
...
switch ($_GET["op"]) {
	...
	case 'listar':
		...
		while ($reg = pg_fetch_object($rspta)) {
			...
			$btnPrint = "<a target=' _blank' href=../reportes/formato_6_pdf.php?id=" . $reg->{'f.id'} . " 'print_compra'>  <i class='fa fa-print text-warning'> </i></a>";
