...
{
	*/
require_once "../modelos/FichaRabia.php";
...
switch ($_GET["op"]){
	case 'save':
		$rs=$ficha->save(
			...
			$_POST['ubigeo'],
			$_POST['telefono_fijo_empresa'],
			$_POST['celular_empresa'],
			$_POST['email_empresa'],
			$_POST['tipo_doc'],
			$_POST['numero_doc'],
			...
			$_POST['vacuna_antirabica'],
			$_POST['vacuna_antitetanica'],
			$_POST['mordedura_ultimo'],
			$_POST['acudio_es'],
			$_POST['conoce_triada'],
			$_POST['facilita_informacion'],
			$_POST['permite_observar'],
			$_POST['verifica_temperatura'],
			$_POST['verifica_equipos'],
			$_POST['apoya_vigilancia'],
			$_POST['guia_sanitaria'],
			$_POST['autoriza_correo'],
			$_POST['cnt_vacuna_sextuple'],
			$_POST['cnt_vacuna_ant_ins'],
			$_POST['cnt_vacuna_ant_lab'],
			limpiarCadena($_POST['nombre_lab']),
			limpiarCadena($_POST['otros_animales']),
			$_POST['id_local'],
			$_POST['id_usuario'],
			$_POST['fecha'],
			to_pg_array($aDet));
	...
	case 'listar':
		...
		$aColumns = array( 'f.id', 'l.nombre', 'f.id', 'f.fecha','e.nombre','e.ruc',
