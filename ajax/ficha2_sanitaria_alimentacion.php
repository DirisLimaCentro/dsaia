...
{
	*/
require_once "../modelos/Ficha2SanAlimentacion.php";
		...
		while ($reg = pg_fetch_object($rspta)) {
			...
			/*$btnPrint="<a href='#' onclick='print_compra(".$reg->{'f.id'}.")'><i class='fa fa-print text-warning'></i></a>";
				 ...
				 (".$reg->{'f.id'}.")
					 ...
					 */
			$btnPrint = "<a href='../reportes/formato_2_pdf.php?id=" . $reg->{'f.id'} . " 'print_compra'><i class='fa fa-print text-warning'><i/></a>";
