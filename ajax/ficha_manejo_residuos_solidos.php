...
{
	*/
require_once "../modelos/FichaResiduosSolidos.php";
...
switch ($_GET["op"]){
	case 'save':
		...
		$arr_ipress = array($_POST['id_ipress'], $_POST['codigo_ipress'], $_POST['nombre_ipress'], $_POST['tipo_ipress'], $_POST['categoria_ipress'], $_POST['ubigeo_ipress'], trim($_POST['direccion_ipress']), trim($_POST['telefono_ipress']));
		$arr_dato = array($_POST['id_local'], $_POST['id_usuario'], $_POST['fecha'], trim($_POST['nombre_responsable_ipress']), trim($_POST['nombre_responsable_eess']), $_POST['i_1'], $_POST['i_2'], $_POST['i_3'], $_POST['i_4'], $_POST['i_5'], $_POST['i_6'], $_POST['i_7'], $_POST['i_8'], $_POST['i_9'], $_POST['i_10'], $_POST['i_11'],$_POST['ii_1'], $_POST['iii_1'], $_POST['iii_2'], $_POST['iii_3'], $_POST['iii_4'], $_POST['iii_5'], $_POST['total_puntaje']);
