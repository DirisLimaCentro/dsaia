...
foreach ($declaracion->iniciar()->query($sql2) as $rows) {
	/*
	...
	$pdf->Cell(50, 10, '', 'T', 0, 'C', false);
	$pdf->SetFont('Arial', 'B', 8);
	$pdf->Cell(100, 10, 'FORMATO 2 - PESCADOS Y MARISCOS', 'T', 0, 'C', false);
	$pdf->SetFont('Arial', 'B', 10);
	$pdf->Cell(50, 10, '', 'T', 1, 'C', false);
	$pdf->SetFont('Arial', 'B', 8);
	...
	$pdf->SetFont('Arial', 'B', 8);
	$pdf->Cell(170, 4, 'TOTAL ', 1, 0, 'L', true);
