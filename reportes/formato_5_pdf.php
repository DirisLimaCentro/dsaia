...
$sql = " select  m.nombre_mercado , * from  ficha_5_mercado  as f
...
foreach ($declaracion->iniciar()->query($sql) as $rows) {
	...
	$pdf->Cell(100, 12, 'FORMATO 5 - COMIDAS PREPARADAS', 'T', 0, 'C', false);
	$pdf->SetFont('Arial', 'B', 10);
...
', 1, 0, 'B', false);
	...
	$pdf->Cell(130, 5, '1.4 Carnes, aves, pescados y mariscos 
totalmente cocidos', 1, 0, 'B', false);
	$pdf->Cell(40, 5, 'SI=4', 1, 0, 'C', false);
	...
	$pdf->Cell(130, 5, utf8_decode('2.3 Recalienta porción a temperatura de seguridad (60 °C a mayor) '), 1, 0, 'B', false);
	$pdf->Cell(40, 5, 'SI=4', 1, 0, 'C', false);
	$pdf->Cell(30, 5, $rows['ii_3'], 1, 1, 'C', false);



	$pdf->Cell(130, 5, utf8_decode('2.4 Prueba los alimentos en forma adecuada '), 1, 0, 'B', false);
	$pdf->Cell(40, 5, 'SI=4', 1, 0, 'C', false);
	$pdf->Cell(30, 5, $rows['ii_4'], 1, 1, 'C', false);


	$pdf->Cell(130, 5, utf8_decode('2.5 Usa agua segura (0,5 ppm)'), 1, 0, 'B', false);
	$pdf->Cell(40, 5, 'SI=4', 1, 0, 'C', false);
	$pdf->Cell(30, 5, $rows['ii_5'], 1, 1, 'C', false);


	$pdf->Cell(130, 5, utf8_decode('2.6 Desinfecta utensilios, vajilla, superficies y secadores'), 1, 0, 'B', false);
	$pdf->Cell(40, 5, 'SI=4', 1, 0, 'C', false);
	...
	$pdf->Cell(130, 5, utf8_decode('2.8 Sirve o despacha en vajilla limpia y desinfectada o descartable de primer uso'), 1, 0, 'B', false);
	$pdf->Cell(40, 5, 'SI=4', 1, 0, 'C', false);
	$pdf->Cell(30, 5, $rows['ii_8'], 1, 1, 'C', false);
...
animales, o signos '), 'LR', 0, 'B', false);
	...
	$pdf->Cell(60, 5, utf8_decode('68 puntos a más (75% a 100%) '), 1, 0, 'B', false);
...
$pdf->SetFont('Arial', 'B', 9);
//$pdf->Cell(290,5,'RESOLUCION ADMINISTRATIVA N '.$fi[0]['resolucion_numero'].' - '.$fi[0]['resolucion_anio'].' DESAIA/DIRIS-LC',1,1,'C');

/*
$pdf->SetFont('Arial','',8);
$pdf->Cell(20,5,'RUC:','LT',0,'L');
//$pdf->Cell(270,5,$fi[0]['ruc'],1,1,'L');
...
$pdf->SetFont('Arial','B',9);
$pdf->SetFillColor( 213, 219, 219 );
$pdf->Cell(290,5,'DATOS DEL PERSONAL MEDICO VETERINARIO QUE LABORA EN EL ESTABLECIMIENTO',1,1,'C',true);
$pdf->SetFillColor(255,255,255);
$pdf->SetFont('Arial','',8);
...
$pdf->SetFont('Arial','B',9);
$pdf->SetFillColor( 213, 219, 219 );
$pdf->Cell(290,5,'DATOS SOBRE LAS ACTIVIDADES PREVENTIVAS DE LA RABIA',1,1,'C',true);
$pdf->SetFillColor(255,255,255);
$pdf->SetFont('Arial','',8);
...
$pdf->Cell(40,5,utf8_decode($fi[0]['ubigeo_ficha']),1,1,'C');


$pdf->SetFont('Arial','B',9);
$pdf->SetFillColor( 213, 219, 219 );
$pdf->Cell(290,5,'NOTIFICACION DE MUESTRAS',1,1,'C',true);
$pdf->SetFillColor(255,255,255);
$pdf->SetFont('Arial','',8);

/*
$pdf->Cell(100,5,'DATOS DE LA MASCOTA','LT',0,'C');
$pdf->Cell(190,5,'DATOS DEL PROPIETARIO',1,1,'C');
