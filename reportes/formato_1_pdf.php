...
$sql = " select  m.nombre_mercado , * from  ficha_1_mercado  as f
...
foreach ($declaracion->iniciar()->query($sql) as $rows) {
	...
	/*
					   ...
					   DE ALIMENTACION EN ESTABLECIMIENTOS DE SALUD (CARNES Y MENUDENCIAS )';
...
$pdf->SetFont('Arial', 'B', 9);
$pdf->SetWidths(array(10, 20, 30, 20, 20, 80, 50, 50));
$j = 0;
