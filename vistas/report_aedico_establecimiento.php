      ...
      <div class="row">
        ...
        <div class="col-md-10 col-sm-6 col-xs-6">
          ...
          <div class="x_panel ">
            ...
            <div class="x_title">
                <h2>Reporte Indice Aedico por Sector y Localidad <a style="visibility:hidden;" target="_blank" id="aDwn" name="aDwn"  href="#" ></a><small></small></h2>
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                       ...
                       <div class="row">
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            <label >Nivel</label>
                            <select class='form-control'  id='id_nivel' onchange="change_header();" >
                              <option value="S" selected="">Sector</option>
                                  ...
                                  <table  id="tblris" class="table table-striped table-bordered dt-responsive table-hover " >
                                    <thead >
                                      <tr class="v-grid-header" >
                                        <th style="width: 20%;" id="td_nivel">Sector</th>
                                        <th ><div>INSPECCIONADAS</div></th>
                                        <th ><div>VIVIENDAS +</div></th>
                                        <th ><div>I.A.</div></th>
...
function filtrar(){
  ...
  $.ajax({
      url: "../ajax/ficha_vivienda.php?op=reportAedicoSector",
      dataType: "json",
      type: "post",
      data: {
        mes: $("#mes_report").val(),
...
$(function () {
	$('#fecha_desde').daterangepicker({
      ...
      /*$.getJSON('../ajax/local.php?op=cboLocales', function(data) {
