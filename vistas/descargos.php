...
//{
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_title">
                <h2>Descargos de insumos <small></small></h2>
                ...
                <div class="modal-dialog modal-lg" role="document">
                  ...
                  <div class="modal-content">
                   ...
                   <div class="modal-header modal-header-success" >
                      ...
                      <h4 class="panel-title" id="modalTitle">Nuevo Descargo</h4>        
                    </div> 
                    ...
                    <div class="modal-body">                     
                              ...
                              <div class="row">
                                  <div class="col-md-12 col-sm-12 col-xs-12 box-header with-border">
                                    <h2 class="box-title">Datos del Descargo</h2>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-2">
                                  <div class="form-group">
                                    <label for="orden">Numero Descargo:</label>
                                ...
                                <div class="col-md-2">
                                  <div class="form-group">
                                    <label for="exampleInputPassword1">Fecha Descargo</label>
                                    <div class="input-group date">
                                      <input type="text" readonly="" class="form-control pull-right" id="fecha_descargo" value="<?=date('d/m/Y');?>" placeholder="Fecha Descargo">
                            ...
                            <div class="row" id="row_btn_item">
                              <div class="col-md-12 ">
                                <div class="form-group">
                                  <button type="button" class="btn btn-success btn-sm" onclick="open_item();"><i class="fa fa-plus"></i> Agregar item</button>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <select class='form-control' name='id_umi' id='id_umi' style="display: none;" ></select>
                                   <input type="text" class="form-control" id="unidad_medida" readonly="" placeholder="Unidad Medida">
                                </div>  
                          </div>
                          <div class="col-md-6">
                              <div class="form-group">
                                  <label >Cantidad</label>
                                   <input type="text" class="form-control" id="cantidad" maxlength="12"  placeholder="0" >
                                </div>  
                          </div>   
  ...
  <script type="text/javascript" src="scripts/descargo.js?rnd=<?php echo rand(); ?>"></script>
  ...
  <script>
    ...
    function editRow(r){
       ...
       // alert($("#"+r+" #td_unidad_medida").html());
        $("#unidad_medida").val($("#"+r+" #td_unidad_medida").html());

        //$("#marca").val($("#"+r+" #td_marca").html());

        $("#marca").val($("#"+r).find("td:eq(2)").text()); 
    ...
    function addRow(){
      ...
      cell3.innerHTML = $("#marca").val();
      cell3.id="td_marca";

      cell4.innerHTML = $("#unidad_medida").val();
      cell4.id="td_unidad_medida";

      cant = $("#cantidad").val()
      cell5.innerHTML = $.trim(cant);
      cell5.id="td_cantidad";
      cell5.className  ='text-right';
     

      cell6.innerHTML = $("#id_item option:selected").val();
      cell6.id="td_id_item";
  ...
  $('#id_item').select2({
    ...
    $('#id_item').on('change', function() {
        ...
        $.post("../ajax/items.php?op=mostrar",{id_item : id_item}, function(data, status){
          data = JSON.parse(data);
           ...
           $("#unidad_medida").val(data.unidad_medida_ingreso);
    ...
    $.getJSON('../ajax/tabla.php?op=list&id_tabla=14', function(data) {
     ...
     $.getJSON('../ajax/persona.php?op=list', function(data) {
      ...
      $('#fecha_descargo').daterangepicker({
...
function save(){
  ...
  $("#tblDet tbody tr").each(function(){
        ...
        var cant=currentRow.find("td:eq(4)").text(); 
        var cnt = cant.split(' ').join('');
        var id_i=currentRow.find("td:eq(5)").text(); 
  ...
  /*if ($('#urgente').is(':checked')){
   ...
   bootbox.confirm({
        ...
        callback: function (result) {
          //console.log('This was logged in the callback: ' + result);
          if (result){           
              $op=($("#id_requerimiento").val()=='')?'saveDescargo':'updateDescargo';
              
              $.ajax({
                type: "POST",
                url: "../ajax/descargo.php?op="+$op,
                //dataType: "json",
                ...
                data : {
                  ...
                  fecha_descargo: $("#fecha_descargo").val(),               
