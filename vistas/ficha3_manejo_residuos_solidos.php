          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_title">
                  ...
                  <br>  <h2>FICHA3  - Verificación De Cumplimiento De Los Aspectos De Gestión De Residuos Sólidos
En Establecimientos De Salud, Servicios Médicos  De Apoyo <BR>
                      De Centros De Investigación (a partir del Nivel II )</h2>
              ...
              <div class="x_content" id="listadoregistros">
                ...
                <?php require  'partials/modal_ficha3_manejo_residuos_solidos.php'; ?>
  ...
  <script type="text/javascript" src="scripts/ficha3_manejo_residuos_solidos.js?rnd=<?php echo rand(); ?>"></script>
