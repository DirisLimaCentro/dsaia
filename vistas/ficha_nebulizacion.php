...
$tabla = new Tabla();
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_title">
                <h2>Ficha Diaria de Nebulizacion <small></small></h2>
                ...
                <div class="modal-dialog modal-md" style="width: 40%; " role="document">
                  ...
                  <div class="modal-content">
                   ...
                   <div class="modal-header modal-header-success" >
                      ...
                      <h4 class="panel-title" >Apertura de Ficha</h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                          ...
                          <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                              ...
                              <input type="text" id="sector_neb" class="form-control text-uppercase">
                          </div>  
                          ...
                          <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                           ...
                           <div class="input-group date">
                            <input type="text" class="form-control pull-right" value="<?=date('d/m/Y');?>"  id="fecha_neb" placeholder="dd/mm/aaaa" >
                          ...
                          <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                              ...
                              <select class='form-control'  id='id_turno_neb'  >
                            </select>
                          </div>
                       ...
                       <div class="row">
                          ...
                          <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                              <label for="exampleInputPassword1">N° Brigada</label>  
                              <input type="number" value="0" id="nro_brigada_neb" class="form-control">
                          </div>  

                          <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                              <label for="exampleInputPassword1">Jefe de brigada</label>  
                              <select class='form-control input-sm select2 itemNamedist text-uppercase'  id='id_jefe_brigada_neb' style="width: 100%"  >
                              </select>
                          </div>  

                          <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                              <label for="exampleInputPassword1">N° Vuelta</label>  
                              <input type="number" value="1" id="nro_vuelta" class="form-control">
                          </div>  
                        ...
                        <div class="row">  
                          ...
                          <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                              ...
                              <input type="time" id="hora_inicio_neb" class="form-control">
                          </div>  


                         <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                              <label for="exampleInputPassword1">Hora Termino</label>  
                              <input type="time" id="hora_termino_neb" class="form-control">
                          </div>  


                          <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                              <label for="">Tipo de Maquina</label>  
                              <input type="text" id="tipo_maquina_neb" class="form-control text-uppercase">                              
                          </div>
                          <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                              <label for="">Insecticida</label>  
                              <input type="text" id="insecticida_neb" class="form-control text-uppercase">                              
                          </div>
                       ...
                       <div class="row"> 
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                              ...
                              <textarea id="observaciones_neb" class="form-control "></textarea>
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                              <label for="">Nebulizador</label>  
                              <select class='form-control input-sm select2 itemNamedist text-uppercase'  id='id_nebulizador' style="width: 100%"  >
                              </select>
                            </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <label for="exampleInputPassword1">Direccion (incluya el distrito para busqueda)</label>
                            <input type="text " class="form-control text-uppercase"  id="direccion_neb"  placeholder="">
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                          <div class="form-group">
                            ...
                            <input type="text " class="form-control text-uppercase" id="latitud_neb"  placeholder="">
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                          <div class="form-group">
                            ...
                            <input type="text " class="form-control text-uppercase" id="longitud_neb"  placeholder="">
                          </div>
                        </div>

                        <div class="col-md-3 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <label for="exampleInputPassword1">Cod Manzana</label>
                            <input type="text " class="form-control text-uppercase" id="codigo_manzana" value=""  placeholder="">
                          </div>
                        </div>

                        <div class="col-md-3 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <label for="exampleInputPassword1">N° Pisos</label>
                            <input type="number" class="form-control " id="nro_pisos" value="0"  placeholder="">
                          </div>
                        </div>

                        <div class="col-md-3 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <label for="exampleInputPassword1">N° Residentes</label>
                            <input type="number " class="form-control " id="nro_residentes" value="0"  placeholder="">
                          </div>
                        </div>

                         <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                              <label for="exampleInputPassword1">Condicion Vivienda</label>
                              <select class='form-control'  id='cbo_condicion_vivienda'  >
                            </select>
                          </div>

                        <div class="col-md-6 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <label for="exampleInputPassword1">Mezcla</label>
                            <input type="text " class="form-control text-uppercase" id="mezcla" value="0.00"  placeholder="">
                          </div>
                        </div>  

                        <div class="col-md-6 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <label for="exampleInputPassword1">Gasolina</label>
                            <input type="text " class="form-control text-uppercase" id="gasolina" value="0.00"  placeholder="">
                          </div>
                        </div> 
  ...
  <script type="text/javascript" src="scripts/ficha_nebulizacion.js?rnd=<?php echo rand(); ?>"></script>
  ...
  <script>
    ...
    function ver(){
      ...
      $("#id_local_destino").val('').trigger('change');
      $("#id_ficha").val('');
      ...
      $("#id_turno_neb").val('');
      $("#nro_brigada_neb").val('');
      $("#id_jefe_brigada_neb").val('').trigger('change');

      $("#nro_vuelta").val('');
      $("#hora_inicio_neb").val('');
      $("#hora_termino_neb").val('');

      $("#tipo_maquina_neb").val('');
      $("#insecticida_neb").val('');
      $("#observaciones_neb").val('');
      $("#id_nebulizador").val('').trigger('change');     
     ...
     /* $('input[type="checkbox"].flat-red, input[type="radio"].flat-red').iCheck({
      ...
      $.ajax( {
          ...
          success: function ( json ) {
            $("#id_jefe_brigada_neb").html( json );
            $("#id_jefe_brigada_neb").select2();

            $("#id_nebulizador").html( json );
            $("#id_nebulizador").select2();
  ...
  $('#id_item').select2({
    ...
    $.getJSON('../ajax/tabla.php?op=list&id_tabla=89', function(data) {
      var template = $('#tpl_turno').html();
      var html = Mustache.to_html(template, data);
      $('#id_turno_neb').html(html);
    });


    $.getJSON('../ajax/tabla.php?op=list&id_tabla=90', function(data) {
      var template = $('#tpl_condition_vivienda').html();
      var html = Mustache.to_html(template, data);
      $('#cbo_condicion_vivienda').html(html);
    });
...
<script id="tpl_turno" type="text/template"><option value='' selected>--Seleccione--</option>
  {{#tablas}}<option value='{{id}}'>{{nombre}}</option>{{/tablas}}
</script>

<script id="tpl_condition_vivienda" type="text/template"><option value='' selected>--Seleccione--</option>
  {{#tablas}}<option value='{{id}}'>{{nombre}}</option>{{/tablas}}
</script>
