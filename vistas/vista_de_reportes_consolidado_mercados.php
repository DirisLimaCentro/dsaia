 ...
 <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <br>
           <h2> - CONSOLIDADO REPORTE DE FICHA SANITARIA EN MERCADOS DE ABASTO
           </h2>
...
<input type="button"   >
        ...
        <div class="x_content" id="listadoregistros">
          <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal">
            + Descargar Consolidado De Fichas Sanitarias 
          </button>
          <form action="../reportes/formato_consolidados.php" target=' _blank' method="post">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>Seleccione Mercado </label>
                          <select class="form-control" style='width: 570px;' name="responsable_mercado"
                            id="responsable_mercado">
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/vista_de_reportes_2.js?rnd=<?php echo rand(); ?>"></script>
<!--
