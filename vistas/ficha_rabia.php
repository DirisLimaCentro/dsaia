        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_title">
                <h2>Ficha Encuesta Vigilancia de Rabia <small></small></h2>
              ...
              <? require 'partials/modal_ficha_rabia.php'; ?>
...
<!-- Modal nueva Localidad--->
  ...
  <script type="text/javascript" src="scripts/ficha_rabia.js?rnd=<?php echo rand(); ?>"></script>
