  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="x_panel">
        ...
        <div class="x_title">
          <h2>Ficha 2 - PESCADOS Y MARISCOS <small>
        ...
        <?php require 'partials/modal_mercado_ficha2_sanitaria_alimentacion.php'; ?>
...
<script type="text/javascript" src="scripts/ficha2_sanitaria_alimentacion.js?rnd=<?php echo rand(); ?>"></script>
