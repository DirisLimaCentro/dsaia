...
//{
  ...
  //{
    ...
    .gmnoprint div[title^="Etiqueta"] {
      font-size: 8px; /* Cambiar el tamaño de la etiqueta */
    }
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_title">
                <h2>Mapa Registro Diario Nebulizacion <small></small></h2>
                              ...
                              <table   class="table table-striped table-bordered table-hover table-responsive ">
                                    <thead>
                                      <tr class="v-grid-header">
                                        ...
                                        <th class="text-center">Viviendas Fumigadas</th>
                                      </tr>
                                    </thead>
  ...
  <script type="text/javascript" src="scripts/ficha_mapa_nebulizacion.js?rnd=<?php echo rand(); ?>"></script>
