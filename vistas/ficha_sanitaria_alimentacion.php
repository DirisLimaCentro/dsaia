        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_title">
                <h2>Ficha Evaluación Sanitaria de Servicios de Alimentación en Establecimiento de Salud <small></small></h2>
              ...
              <? require 'partials/modal_ficha_sanitaria_alimentacion.php'; ?>
...
<!-- Modal nueva Localidad--->
  ...
  <script type="text/javascript" src="scripts/ficha_sanitaria_alimentacion.js?rnd=<?php echo rand(); ?>"></script>
