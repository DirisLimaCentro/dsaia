...
$tabla = new Tabla();
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_title">
                <h2>Ficha Inspeccion de Viviendas para Vigilancia y Control de Aedes aegypti <small></small></h2>
                ...
                <table id="tbllistado" class="table table-striped table-bordered  table-hover " cellspacing="0" style="width: 100%">
                  <thead>
                    <tr class="v-grid-header">
                      ...
                      <th>ID Ubigeo</th>
                      <th>Distrito Establecimiento</th>
                ...
                <div class="modal-dialog modal-md"  role="document">
                  ...
                  <div class="modal-content">
                   ...
                   <div class="modal-header modal-header-success" >
                      ...
                      <input type="hidden" id="cboid_ubigeo">
                      <input type="hidden" id="cbotext_ubigeo">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="form-group">
                            ...
                            <select disabled="" class="form-control select2 itemNamedist text-uppercase"    id='id_establecimiento'  style="width: 100%" onchange="getLocalidades('');"  >
                            </select>
                      ...
                      <div class="row">                    
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                              <label for="exampleInputPassword1">Inspector <a href="#" onclick="openNuevoPersonal()"><span class="badge bg-green">Nuevo Registro</span></a> </label>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                          <div class="form-group">
                            ...
                            <select class='form-control'  id='id_tipo_actividad' onchange="display_paciente()"  >
                            </select>
                          </div>
                        </div>
                      ...
                      <div class="row" id="div_paciente" style="display: none">
                        <div class="col-md-3 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <label for="exampleInputPassword1">Tipo de Doc Paciente</label>
                            <select class='form-control'  id='id_tipo_documento_paciente'  >   
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <label for="exampleInputPassword1">Numero Doc del Paciente</label>
                            <input type="text" id="numero_documento_paciente" class="form-control text-uppercase">  
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12">
                          <div class="form-group">
                            ...
                            <input type="text" id="nombres_paciente" class="form-control text-uppercase">  
                          </div>
                        </div>

                        <div class="col-md-3 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <label for="exampleInputPassword1">Tipo de Contagio</label>
                            <select class='form-control'  id='id_tipo_paciente'  >   
                              <option value="" selected="">--Seleccione--</option>
                              <?
                              $rspta=$tabla->select('92');
                              while ($reg=pg_fetch_object($rspta)){
                                echo "<option value='".$reg->id_tipo."' >".$reg->descripcion."</option>";}
                                ?>                           
                              </select>
                      ...
                      <div class="row" id="div_ovitrampa" style="display: none">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <label for="exampleInputPassword1">Direccion ubicacion ovitrampa</label>
                            <input type="text" id="direccion_ovitrampa" class="form-control text-uppercase">  
                          </div>
                        </div>
                      </div>
              ...
              <div data-toggle="modal"data-toggle="modal" class="modal fade" data-backdrop="static" style="overflow-y: scroll;" id="modalNew"  role="dialog" aria-labelledby="modalNew" aria-hidden="true" tabindex="-1" >
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-2 col-sm-12 col-xs-12">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="serie_documento" placeholder="Serie">
                                  </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                  <div class="form-group">
                                    ...
                                    <label for="exampleInputPassword1">Fecha Compra</label>
                                    <div class="input-group date">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                        <div class="col-md-8 col-sm-12 col-xs-12">
                         <div class="form-group">
                          ...
                          <input type="text " class="form-control text-uppercase"  id="direccion_familia"  placeholder="" onblur="buscar_lat_()">
                        </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <label >Latitud  <!--<a href="#" onclick="obtenerUbicacionActual()"><span class="badge bg-red">Obtener ubicación actual</span></a>-->
                              <a href="#" onclick="obtenerUbicacionActual()"><span class="badge bg-green">Abrir mapa</span></a>
                            </label>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                          <div class="form-group">
                            ...
                            <select class='form-control'  id='id_condicion_vivienda' onchange="show_div_depositos()"  >
                            </select>
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <label for="exampleInputPassword1">N° Hab</label>
                            <input type="number" disabled="" class="form-control" id="nro_habitantes"  placeholder="">
                          </div>
                        </div>

                         <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Cant Casos DENGUE:</label>
                                <input type="number" disabled="" class="form-control" value="0" id="cantidad_probable_dengue"  placeholder="">
                            </div>
                          </div>
                      ...
                      <div class="row" id="div_depositos" style="display: none;">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-2 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <input  id="cnt_larvicidas" disabled="" onfocus="this.select();" class="form-control"  value="0.00"  placeholder="">
                          </div>
                        </div>
                        ...
                        <div class="col-md-2 col-sm-12 col-xs-12 ">
                          <div class="form-group">
                            <input  id="cnt_febriles" disabled="" class="form-control text-right"  value="0"  placeholder="">
                          </div>
                        </div>
                    ...
                    <div class="modal-footer">
                      <button type="button" onclick="save_item();" class="btn btn-success"><i class="fa fa-check"></i> Guardar</button>
                      ...
                      <div class="row">      
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <div class="radio">
                              <label>
                                <input type="radio" class="flat" value="M" checked name="optTipoReport"> Por Meses
                              </label>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-md-5">
                              <div class="form-group">
                                  <label >Mes</label>
                                  <select class='form-control' multiple  id='mes_report' data-actions-box="true" data-select-all-text="Todos" data-live-search="true" data-deselect-all-text="Ninguno" data-style="btn-default" >
                      ...
                      <div class="row">      
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <div class="radio">
                              <label>
                                <input type="radio" class="flat" value="F"  name="optTipoReport"> Por Fecha
                              </label>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-5">
                          ...
                          <div class="input-group date">
                            <input type="text" class="form-control pull-right" id="date_from" placeholder="dd/mm/aaaa" >
                            <div class="input-group-addon">
                              <i class="fa fa-calendar"></i>
                            </div>
                          </div>
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="input-group date">
                            <input type="text" class="form-control pull-right" id="date_to" placeholder="dd/mm/aaaa" >
                            <div class="input-group-addon">
                              <i class="fa fa-calendar"></i>
                            </div>
                          </div>
                      ...
                      <div class="row">
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                  ...
                                  <select class='form-control'  id='id_condicion_laboral'  >
                                    <option value="" selected="">--Seleccione--</option>
                                    <?
              ...
              <!--Modal Mapa  -->
               <div class="modal fade" id="modalMapa"  role="dialog" aria-labelledby="" aria-hidden="true" tabindex="-1">
                ...
                <div class="modal-dialog modal-md" role="document">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-header modal-header-info" >
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                      <h4 class="panel-title" id="modalItemTitle">Seleccione una ubicación</h4>
                    </div>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                          <div class="col-md-12">
                              <label class='form-control'>Ubique el marcador rojo en la posición deseada</label>
                          </div>
                      </div>    
                      ...
                      <div class="row">
                          <div class="col-md-12">
                              ...
                              <!--<input id="pac-input" class="form-control" type="text" placeholder="Buscar lugar">-->
  ...
  <script type="text/javascript" src="scripts/ficha_vivienda.js?rnd=<?php echo rand(); ?>"></script>
  <script type="text/javascript" src="../public/js/mustache.min.js"></script>

<!--  <script src="https://unpkg.com/leaflet@1.9.1/dist/leaflet.js"></script>
<script src="https://unpkg.com/leaflet-geocoder@3.1.1/dist/leaflet-geocoder.js"></script>-->
...
<!--&callback=initAutocomplete-->
 <!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC-cJjTIIjuLlqqpMZd9z7OefBzC_bef_g&libraries=places&callback=initAutocomplete" async defer ></script>-->
  ...
  <script>
    ...
    function obtenerUbicacionActual(){
      ...
      /*const markersLayer = map.getMarkers();
      let marker;
      while (marker = markersLayer.next()) {
      ...
      id="wosm";
      urlwindow="pop_osm.php";
      Xpos=(screen.width/2)-300;
      Ypos=(screen.height/2)-250;
      eval("pagew" + " = window.open(urlwindow, '" + id + "', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=600,height=500,left = '+Xpos+',top = '+Ypos);");
    ...
    function ver(){
      ...
      $("#id_tipo_documento_paciente").val('');
    ...
    $(function () {
     ...
     /* $('input[type="checkbox"].flat-red, input[type="radio"].flat-red').iCheck({
      ...
      $.ajax( {
          url: '../ajax/local.php?op=listaLocales',
          //data:  parametros,
          dataType: 'json',
          async: false,
  ...
  $('#id_item').select2({
    ...
    /*$.getJSON('../ajax/tabla.php?op=list&id_tabla=16', function(data) {
      ...
      $("#id_establecimiento").val($("#s_id_local").val()).trigger('change');

      if ($("#s_id_nivel").val()=='5' || $("#s_id_nivel").val()=='1'){  //digitadores
...
function save(){
  ...
  if ($("#id_tipo_actividad").val()==''){
   ...
   if ($("#id_usuario_registro").val()==''){
    bootbox.alert('Seleccione inspector');
    $("#id_usuario_registro").focus();
    return false;
  }
          ...
          if (result){
              ...
              $.ajax({
                ...
                data : {
                  ...
                  id_tipo_documento_paciente: $("#id_tipo_documento_paciente").val(),
                  numero_documento_paciente: $("#numero_documento_paciente").val(),
                  nombres_paciente: $("#nombres_paciente").val().toUpperCase(),

                  id_tipo_paciente: $("#id_tipo_paciente").val(),
                  id_usuario_inspector: $("#id_usuario_registro").val(),
                  direccion_ovitrampa: $("#direccion_ovitrampa").val().toUpperCase()
