      ...
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-6">
          ...
          <div class="x_panel ">
            ...
            <div class="x_title">
                <h2>Reporte de Salidas de Almacen <a style="visibility:hidden;" target="_blank" id="aDwn" name="aDwn"  href="#" ></a><small></small></h2>
                  ...
                  <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        	...
                        	<div class="row">
                        		<div class="col-md-12 col-sm-12 col-xs-12">
                        			 <div class="form-group">
                        			 	 <label for="id_area" class="col-form-label">Area Destino</label>
...
function to_excel(){
  ...
  if (cntCat==cntSel){
	...
	document.getElementById('aDwn').setAttribute('href',"../reportes/xlsDespachos.php?desde="+$("#fecha_desde").val()+"&hasta="+$("#fecha_hasta").val()+"&id_empresa="+strEmpresas.toString()+"&id_local="+strProv+"&id_personal="+strPer+"&id_catalogo="+strCat);
	document.getElementById('aDwn').click();
}
