      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 col-xs-6">
          ...
          <div class="x_panel ">
            ...
            <div class="x_title">
                <h2>Resultado del parametro de cloro residual<small></small></h2>
        ...
        <div class="col-md-4 col-sm-6 col-xs-6">
          ...
          <div class="x_panel ">
            ...
            <div class="x_title">
                <h2>Resultado parametro pH<a style="visibility:hidden;" target="_blank" id="aDwn" name="aDwn"  href="#" ></a><small></small></h2>
                <ul class="nav navbar-right panel_toolbox">
                  <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                  </li>
                  <li class="dropdown">
        ...
        <div class="col-md-4 col-sm-6 col-xs-6">
          ...
          <div class="x_panel ">
            ...
            <div class="x_title">
                <h2>Resultado parametro Turbidez<small></small></h2>
                <ul class="nav navbar-right panel_toolbox">
                  <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                  </li>
                  <li class="dropdown">
...
function consultar1(){
    ...
    $.ajax({
      url: "../ajax/ficha_cloro_residual.php?op=reportCalidadAgua",
      dataType: "json",
      type: "post",
      data: {        
        anio: $("#anio").val(),
