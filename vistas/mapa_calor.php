...
//{
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_title">
                <h2>Mapa de Calor <small></small></h2>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                       ...
                       <div class="row">  
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                          <div class="radio">
                            <label>
                              <input type="radio" id="tipo_ag1"  checked name="tipoag" value="D" onclick="filtrar()" > Agrupar por distrito
                            </label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" id="tipo_ag2"  name="tipoag" value="R" onclick="filtrar()"> Agrupar por RIS
                            </label>
                          </div>
                        </div>
                      </div>  
                      ...
                      <div class="row">  
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                          <div class="radio">
                            <label>
                              <input type="radio" id="tipo1"  checked name="tiporeporte" value="T" onclick="filtrar()" > Filtrar Viviendas Positivas
                            </label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" id="tipo2"  name="tiporeporte" value="C" onclick="filtrar()"> Filtrar Cerco Entomológico
                            </label>
                          </div>
                        </div>
                      </div>  
                              ...
                              <table   class="table table-striped table-bordered table-hover table-responsive ">
                                    <thead>
                                      <tr class="v-grid-header">
                                        ...
                                        <th class="text-center">Cant Viviendas +</th>
                      ...
                      <div class="row">  
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                            <a href="../../dengue/back_3/" class="btn btn-success" target="_blank">Mapa Dengue</a>
                        </div>
                      </div>  
  ...
  <script type="text/javascript" src="scripts/ficha_mapa.js?rnd=<?php echo rand(); ?>"></script>
  ...
  <script>
    ...
    /*var map = L.map('map').setView([-12.0545376, -77.0546407], 13);
...
function agregar_poligonos(){

  

  // Crear el polígono y agregarlo al mapa
  var polygon = L.polygon(coordenadasPoligono, { color: 'blue' }).addTo(map);
}
