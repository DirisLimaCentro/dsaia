  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="x_panel">
        ...
        <div class="x_title">
          <h2>Ficha 3 - FRUTAS Y HORTALIZAS <small>
        ...
        <?php require 'partials/modal_mercado_ficha3_sanitaria_alimentacion.php'; ?>
...
<script type="text/javascript" src="scripts/ficha3_sanitaria_alimentacion.js?rnd=<?php echo rand(); ?>"></script>
