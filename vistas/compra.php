...
//{
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                      ...
                      <div class="row">
						  ...
						  <div class="col-md-4">
                              <div class="form-group has-success has-feedback">
                                  <label class="text-success">Stock Actual</label>
                                  <input type="text" class="form-control text-success" id="stock_real" readonly="" placeholder="Stock">
                                </div>
                          </div>
              ...
              <div class="modal fade" id="modalPrint" data-backdrop="static" role="dialog" aria-labelledby="modalItem" aria-hidden="true" tabindex="-1">
                ...
                <div class="modal-dialog modal-md" role="document">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-header modal-header-success" >
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                      <h4 class="panel-title" id="modalItemTitle">Imprimir Compras</h4>
                    </div>
                    ...
                    <div class="modal-footer">
                      <button type="button" onclick="printCompras();" class="btn btn-success"><i class="fa fa-print"></i> Imprimir</button>
                      <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-remove"></i> Cancelar</button>
  ...
  <script type="text/javascript" src="scripts/compra.js?rnd=<?php echo rand(); ?>"></script>
        ...
        addRow();
              ...
              if ($("#id_ingreso").val()!=''){
                //Guardando cambios///
                    if (newItem==true){
                        act='I';
                        msj="Esta seguro de agregar el item a la compra?";
                    }else{
  ...
  for(var i=0; i<rowCount; i++) {
   ...
   bootbox.confirm({
        ...
        callback: function (result) {
          //console.log('This was logged in the callback: ' + result);
          if (result){
              $op=($("#id_ingreso").val()=='')?'saveCompra':'updateCompra';

              $.ajax({
                type: "POST",
                url: "../ajax/compra.php?op="+$op,
                //dataType: "json",
