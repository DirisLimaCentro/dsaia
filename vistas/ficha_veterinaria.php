...
//{
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_title">
                <h2>Ficha Formato de Consolidado de Vacunacion Antirábica Canina <small></small></h2>
              ...
              <? include "partials/modal_ficha_veterinaria.php"; ?>
                ...
                <div class="modal-dialog modal-md" role="document" style="width: 50%">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-header modal-header-success" >
                      ...
                      <h4 class="panel-title" id="modalItemTitle">Ingrese Noficacion de Muestras </h4>
                    </div>
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="row">
                                 ...
                                 <div class="col-md-3 col-sm-12 col-xs-12">
                                  <div class="form-group">
                                   <label for="razon_social">Especie:</label>
                                   <select class='form-control'  id='id_especie'  >
                                    </select>
                                 </div>
                               </div>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text"  class="form-control text-uppercase" id="nombre_mascota" placeholder="">
                              </div>
                            </div>
                               
                               <div class="col-md-3 col-sm-12 col-xs-12">
                                  <div class="form-group">
                                   <label for="razon_social">Sexo:</label>
                             ...
                             <div class="col-md-3 col-sm-12 col-xs-12">
                              <div class="form-group">
                                ...
                                <input type="text"  class="form-control text-uppercase" id="edad_mascota" placeholder="">
                              </div>
                            </div>
                            ...
                            <div class="panel-body">
                              <div class="row">
                               ...
                               <div class="col-md-4 col-sm-12 col-xs-12">
                                  ...
                                  <div class="form-group">
                                    <label for="razon_social">Nombre Apellidos:</label>
                                    <input type="text"  class="form-control text-uppercase" id="propietario" placeholder="">
                                  </div>
                               ...
                               <div class="col-md-4 col-sm-12 col-xs-12">
                                  ...
                                  <div class="form-group">
                                    <label for="razon_social">Tlf/Cel:</label>
                                    <input type="text"  class="form-control text-uppercase" id="telefono_propietario" placeholder="">
                                  </div>
                               ...
                               <div class="col-md-4 col-sm-12 col-xs-12">
                                  ...
                                  <div class="form-group">
                                    <label for="id_ubigeo_propietario">Distrito:</label>
                                     <select  class='form-control select2  text-uppercase' name='id_ubigeo_propietario' id='id_ubigeo_propietario' style="width: 100%;" >
                                      </select>
  ...
  <script type="text/javascript" src="scripts/ficha_veterinaria.js?rnd=<?php echo rand(); ?>"></script>
  ...
  <script>
    ...
    function ver(){
      ...
      $("#establecimiento").val($("#s_empresa").val())
      $("#distrito_empresa").val($("#s_distrito_empresa").val())
      $("#ruc_empresa").val($("#s_ruc_empresa").val())
      $("#telefono_empresa").val($("#s_telefono_empresa").val())
      $("#direccion_empresa").val($("#s_direccion_empresa").val())
      $("#correo_empresa").val($("#s_correo_empresa").val())
      $("#nombre_comercial_empresa").val($("#s_nombre_comercial").val())
      ...
      $("#cmvp_persona").val('');
      $("#mes_reporte").val($("#s_mes").val());

      $("#vac_ant_pri_men_1").val('0');
      $("#vac_ant_pri_may_1").val('0');
      $("#vac_ant_rev_men_1").val('0');
      $("#vac_ant_rev_may_1").val('0');

      $("#vac_sex_pri_men_1").val('0');
      $("#vac_sex_pri_may_1").val('0');
      $("#vac_sex_rev_men_1").val('0');
      $("#vac_sex_rev_may_1").val('0');

      //$('#resolucion_numero').append("<option value='' selected='selected'></option>");
      /*$("#resolucion_numero").select2("val", "");
      $("#resolucion_numero").trigger('change');*/

      $("#resolucion_numero").val('').trigger('change');
      $("#resolucion_anio").val('').trigger('change');
      $("#ubigeo_persona").val('').trigger('change');
      $("#ubigeo_reporte").val('').trigger('change');

      $("#numero_doc").prop("disabled",false);
      
      //$('#ubigeo_reporte').append("<option value='' selected='selected'></option>");
    ...
    $.ajax( {
      url: '../ajax/tabla.php?op=cboReso',
      data:  {"id":"80"},
      dataType: 'html',
      success: function ( json ) {
        $("#resolucion_numero").html( json );
        $("#resolucion_numero").select2();
    ...
    $.ajax( {
      ...
      dataType: 'html',
      success: function ( json ) {
        $("#resolucion_anio").html( json );
        $("#resolucion_anio").select2();
  ...
  $('#id_item').select2({
    ...
    $.getJSON('../ajax/tabla.php?op=list&id_tabla=40', function(data) {
      var template = $('#tpl_especie').html();
      var html = Mustache.to_html(template, data);
      $('#id_especie').html(html);
    });

     $.getJSON('../ajax/tabla.php?op=list&id_tabla=82', function(data) {
      var template = $('#tpl_sexo').html();
      var html = Mustache.to_html(template, data);
      $('#id_sexo').html(html);
    });
...
function save(){
    ...
    if ($("#s_id_local").val()==''){
      bootbox.alert('Error no existe establecimiento');   
      return false;
    }

    if ($("#resolucion_numero").val()==''){
      bootbox.alert('Seleccione numero de resolucion!!!');
      return false;
    }

    if ($("#resolucion_anio").val()==''){
      bootbox.alert('Seleccione año de resolucion!!!');
      return false;
    }
    ...
    var ubigeo_persona=$("#ubigeo_persona").val();
    var telefono_persona=$("#telefono_persona").val();
    var cmvp_persona=$("#cmvp_persona").val();


    var mes_reporte=$("#mes_reporte").val();
    var vac_ant_pri_men_1=$("#vac_ant_pri_men_1").val();
    var vac_ant_pri_may_1=$("#vac_ant_pri_may_1").val();
    var vac_ant_rev_men_1=$("#vac_ant_rev_men_1").val();
    var vac_ant_rev_may_1=$("#vac_ant_rev_may_1").val();

    var vac_sex_pri_men_1=$("#vac_sex_pri_men_1").val();
    var vac_sex_pri_may_1=$("#vac_sex_pri_may_1").val();
    var vac_sex_rev_men_1=$("#vac_sex_rev_men_1").val();
    var vac_sex_rev_may_1=$("#vac_sex_rev_may_1").val();

    var ubigeo_reporte=$("#ubigeo_reporte").val();

    if (!tipo_doc) msg="Seleccione tipo de documento de identidad";
    else if (!numero_doc) msg="Ingrese numero de documento de identidad";
    else if (!nombres) msg="Ingrese nombres";
    else if (!ape_paterno) msg="Ingrese apellido paterno";
    else if (!ape_materno) msg="Ingrese apellido materno";
    else if (!direccion_persona) msg="Ingrese direccion";
    else if (!ubigeo_persona) msg="Ingrese distrito del medico";
    else if (!telefono_persona) msg="Ingrese telefono de la persona";
    else if (!cmvp_persona) msg="Ingrese CMVP";
    else if (!mes_reporte) msg="Ingrese mes de reporte";
    else if (!vac_ant_pri_men_1) msg="Ingrese un valor para Vacuna Ant. Primovacunado Menor 1 año";
    else if (!vac_ant_pri_may_1) msg="Ingrese un valor para Vacuna Ant. Primovacunado Mayor 1 año";
    else if (!vac_ant_rev_men_1) msg="Ingrese un valor para Vacuna Ant. Revacunado Menor 1 año";
    else if (!vac_ant_rev_may_1) msg="Ingrese un valor para Vacuna Ant. Revacunado Mayor 1 año";

    else if (!vac_sex_pri_men_1) msg="Ingrese un valor para Vacuna Sextuple Primovacunado Menor 1 año";
    else if (!vac_sex_pri_may_1) msg="Ingrese un valor para Vacuna Sextuple Primovacunado Mayor 1 año";
    else if (!vac_sex_rev_men_1) msg="Ingrese un valor para Vacuna Sextuple Revacunado Menor 1 año";
    else if (!vac_sex_rev_may_1) msg="Ingrese un valor para Vacuna Sextuple Revacunado Mayor 1 año";
   ...
   bootbox.confirm({
        ...
        callback: function (result) {
          ...
          if (result){
              ...
              id_per=($("#id_persona").val()=='')?'0':$("#id_persona").val();
              $.ajax({
                type: "POST",
                ...
                data : {
                  ...
                  resolucion_numero: $("#resolucion_numero").val(),             
                  resolucion_anio: $("#resolucion_anio").val(), 
                  tipo_doc: $("#tipo_doc").val(),
                  numero_doc: $("#numero_doc").val().toUpperCase(),
                  ...
                  cmvp_persona: $("#cmvp_persona").val().toUpperCase(),
                  mes_reporte: $("#mes_reporte").val(),
                  vac_ant_pri_men_1: $("#vac_ant_pri_men_1").val(),
                  vac_ant_pri_may_1: $("#vac_ant_pri_may_1").val(),
                  vac_ant_rev_men_1: $("#vac_ant_rev_men_1").val(),
                  vac_ant_rev_may_1: $("#vac_ant_rev_may_1").val(),
                  vac_sex_pri_men_1: $("#vac_sex_pri_men_1").val(),
                  vac_sex_pri_may_1: $("#vac_sex_pri_may_1").val(),
                  vac_sex_rev_men_1: $("#vac_sex_rev_men_1").val(),
                  vac_sex_rev_may_1: $("#vac_sex_rev_may_1").val(),
                  ubigeo_reporte: $("#ubigeo_reporte").val(),
...
<script id="tpl_especie" type="text/template"><option value='' selected>--Seleccione Especie--</option>
  {{#tablas}}<option value='{{id}}'>{{nombre}}</option>{{/tablas}}
</script>

<script id="tpl_sexo" type="text/template"><option value='' selected>--Seleccione Sexo--</option>
  {{#tablas}}<option value='{{id}}'>{{nombre}}</option>{{/tablas}}
</script>
