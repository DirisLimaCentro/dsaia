...
function update_child(row){
	...
	$.ajax( {
		url: '../ajax/otrosingresos.php?op=detalleCompra',
		data:  parametros,
		dataType: 'html',
...
function listar()
{
...

	{
		...
		buttons: [
        {
            ...
            autoClose: true,
            buttons: [
                { text: 'Nuevo Registro',   action: function () { ver(); } }
	    ...
	    /*buttons: [
      	...
      	"sAjaxSource": "../ajax/otrosingresos.php?op=listar", // Load Data
		/*"ajax":
				{
