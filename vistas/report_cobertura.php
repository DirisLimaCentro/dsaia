      ...
      <div class="row">
        ...
        <div class="col-md-10 col-sm-6 col-xs-6">
          ...
          <div class="x_panel ">
            ...
            <div class="x_title">
                <h2>Grafica Cobertura e Indice AEDICO <a style="visibility:hidden;" target="_blank" id="aDwn" name="aDwn"  href="#" ></a><small></small></h2>
            ...
            <div class="x_content" id="listadoregistros">
                  ...
                  <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                       ...
                       <div class="col-md-2 col-sm-12 col-xs-12">
                        <label for="" class="col-form-label">&nbsp;</label>
                            <div class="form-group">
                                <a onclick="filtrar();" class="btn btn-default btn-success btn-sm" tabindex="0" aria-controls="tbllistado" href="#"><span><i class="fa fa-filter "></i> Filtrar </span></a>
                              </div>
                       </div>
                     ...
                     <div class="row">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="responsive"  id="echart_resumen" style="height:380px; ">
