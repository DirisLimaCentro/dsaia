              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <table class="table  table-bordered table-condensed table-hover " style="width: 100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>1.2 Aspecto normal de frutas y hortalizas y sin parasitos ( huevos , gusanos ).</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>1.3 No vende frutas y hortalizas picadas .</td>
                    ...
                    <tr>
                      <td>2.1 Estiba a una altura minima de 0,20m del piso .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.4 Despacha en bolsas plasticas transparentes o blancas , o de papel de primer uso ..</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>4.3 Parihuelas para estiba en buen estado y limpias .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>4.4 Utensilios en buen estado y limpias .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>4.5 Basura bien dispuesta ( tacho c/bolsa interior y tapa ).</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>4.6 Ausencia de vectores , roedores u otros familiares , o signos de su presenciq (
                        excrementos u otros ).</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>4.7 Guarda el material de limpieza y desinfeccion separados de animales .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
