              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <table class="table  table-bordered table-condensed table-hover " style="width: 100%">
                  ...
                  <tbody> 
                      ...
                      <tr>
                        <td>1.1 Productos industrializados con registro sanitario y fecha vigente  .</td>
                       ...
                       <tr>
                        <td>1.2 Aspecto normal  de envasados ( enlatados y embolsados ).</td>
                        <td class="text-center">SI=4</td>
                        <td class="text-center">
                       ...
                       <tr>
                        <td>1.3 Aspecto normal de alimentos de granel secos ( menestras , cereales , condimentos , etc ) y ausencia de insectos parasitos  .</td>
                        <td class="text-center">SI=4</td>
                        <td class="text-center">
                       ...
                       <tr>
                           <td>1.4 Aspecto normal de salsas , aderezos , etc  .</td>
                           <td class="text-center">SI=4</td>
                           <td class="text-center">
                               <select id="i_4"  class="form-control text-right"  name="coda3" >
                                   <option value="0">0</option>
                                   <option value="4">4</option>
                       ...
                       <tr class="v-grid-header">
                           ...
                           <th class="text-center"><input type="text"    disabled   placeholder=""   id="total_puntaje1" class="form-control text-right text-success " value="0"></th>
                       </tr>
                      ...
                      <tr class="v-grid-header">
                       ...
                       <tr>
                           <td>2.1 Aplica frio (5° C o menos ) en conservacion de embutidos y lacteos (*).</td>
                           <td class="text-center">SI=4</td>
                           <td class="text-center">
                       ...
                       <tr>
                        <td>2.2 Aplica temperatura de frio ( 5°C o menos ) en la conservacion  de salsas , aderezos , etc  </td>
                        <td class="text-center">SI=4</td>
                        <td class="text-center">
                       ...
                       <tr>
                        <td>2.3 Exhibe ordenadamente  , separado por producto  en recipientes de facil limpieza . </td>
                        <td class="text-center">SI=4</td>
                        <td class="text-center">
                       ...
                       <tr>
                        <td>2.4 Despacha segun sea aplicable ,en bolsas plasticas transparentes blancas , papel poligrasa .</td>
                       ...
                       <tr>
                        <td>2.5 Desinfecta utensilios  , superficies , paños y equipos  .</td>
                        <td class="text-center">SI=4</td>
                        <td class="text-center">
                       ...
                       <tr>
                           <td>2.6 Realiza rotacion de stock   .</td>
                           <td class="text-center">SI=4</td>
                           <td class="text-center">
                               <select id="ii_6" name="coda4" class="form-control text-right">
                                   <option value="0">0</option>
                                   <option value="4">4</option>
                           </td>
                       ...
                       <tr class="v-grid-header">
                           ...
                           <th class="text-center"></th>
                           <th class="text-center"><input type="text"  disabled  placeholder=""    id="total_puntaje2" class="form-control text-right text-success " value="0"></th>
                       </tr>
                      ...
                      <tr>
                       ...
                       <tr>
                        <td>3.2 Manos limpias y sin joyas  , con uñas cortas , limpias y sin esmalte . </td>
                        <td class="text-center">SI=4</td>
                        <td class="text-center">
                       ...
                       <th class="text-center"></th>
                       <th class="text-center"><input type="text"  disabled  placeholder=""    id="total_puntaje3" class="form-control text-right text-success " value="0"></th>
                       </tr>
                       ...
                       <tr>
                           <td>4.1 Exterior e interior del puesto limpio y ordenado  .</td>
                           <td class="text-center">SI=4</td>
                           <td class="text-center">
                       ...
                       <tr>
                           <td>4.2  Superficie  para cortar en buen estado y limpia .</td>
                           <td class="text-center">SI=4</td>
                           <td class="text-center">
                       ...
                       <tr>
                           <td>4.3 Equipos y utensillios en buen estado y limpio .</td>
                           <td class="text-center">SI=4</td>
                           <td class="text-center">
                       ...
                       <tr>
                           <td>4.4 Mostrador de exhibicion en buen estado y limpio .</td>
                           <td class="text-center">SI=4</td>
                           <td class="text-center">
                       ...
                       <tr>
                           <td>4.5 Paños , secadores en buen estado y limpio .</td>
                           <td class="text-center">SI=4</td>
                           <td class="text-center">
                       ...
                       <tr>
                           <td>4.6 Basura bien dispuesta ( tacho c/bolsa interior y tapa ).</td>
                           <td class="text-center">SI=4</td>
                           <td class="text-center">
                       ...
                       <tr>
                           <td>4.7 Desague con sumidero , rejilla  y trampa en buena condicion . </td>
                           <td class="text-center">SI=4</td>
                           <td class="text-center">
                       ...
                       <tr>
                           <td>4.8  Ausencia  de vectores , roedores  u otros animales o signos de su presencia ( excremento u otros ).</td>
                           <td class="text-center">SI=4</td>
                           <td class="text-center">
                       ...
                       <tr>
                           <td>4.9 Guarda el material de limpieza y desinfeccion  separados de los alimentos  .</td>
                           <td class="text-center">SI=4</td>
                           <td class="text-center">
                       ...
                       <tr class="v-grid-header">
                           ...
                           <th class="text-center">
                               <input   disabled value="0"  id="total_puntaje4"  placeholder="" class="form-control text-right text-success ">
                       ...
                       <tr class="v-grid-header">
                           ...
                           <th class="text-center">  </th>
                           <th class="text-center"><input type="text"   disabled  placeholder=""   name="total_puntaje5"  id="total_puntaje5" class="form-control text-right text-success " value="0"></th>
                       ...
                       <tr class="v-grid-header">
                           ...
                           <th class="text-center"></th>
                           <th class="text-center"><input type="text"  disabled    placeholder=""   id="total_puntaje6" class="form-control text-right text-success " ></th>
