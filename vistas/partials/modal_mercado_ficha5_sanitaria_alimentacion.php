              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <table class="table  table-bordered table-condensed table-hover " style="width: 100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>1.4 Carnes , aves , pescados y mariscos totalmente cocidos .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.3 Recalienta porcion a temperatura de seguridad (60 °C a mayor ). </td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.4 Prueba alimentos de forma adecuada .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.5 Usa agua segura (0,5 ppm ) .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.6 Desinfecta utensilios , vajilla , superficies y secadores .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.8 Sirve o despacha en vajilla limpia y desinfectada o descartable de primer uso .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                        <select id="ii_8" name="coda4" class="form-control text-right">
                          <option value="0">0</option>
                          <option value="4">4</option>
                      </td>
