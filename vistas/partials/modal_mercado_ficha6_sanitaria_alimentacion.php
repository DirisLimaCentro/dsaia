            ...
            <div class="row">
             ...
             <div class="col-md-3 col-sm-12 col-xs-12">
              <div class="form-group">
                ...
                <input type="text"  class="form-control" id="responsable_mercado" placeholder="Ingrese Nombre del Mercado">
              </div>
            </div>
...
-->
              ...
              <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="razon_s" placeholder="Ingrese nombre de Razon Social">
                </div>
              </div>
              ...
              <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="numero_puesto" placeholder="Ingrese Puesto">
                </div>
              </div>
              ...
              <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="tipo_alimentos" placeholder="Ingrese tipo de Alimentos">
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="n_inspector" placeholder="Ingrese Nombre Inspector ">
                </div>
              </div>
              ...
              <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="n_vendedor" placeholder="Ingrese Nombre Vendedor">
                </div>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <table class="table  table-bordered table-condensed table-hover " style="width: 100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>1.1 Aspecto normal de los insumos .</td>
                    ...
                    <tr>
                      <td>1.2 Agua segura (0,5 ppm ) para preparar (*) .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>1.3 Hielo de agua segura para bebidas .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.1 Aplica temperatura de frio en la conservacion (5° C o menos ).</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.2 Protege alimentos exhibidos . </td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.3 No prueba los alimentos con los utensilios de preparacion. </td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.4 Usa agua segura (0,5 ppm).</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.5 Lava y desinfecta equipos , utensilios , superficies y secadores .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.6 Sirve en vasos en buen estado , limpios y desinfectados o en vasos descartables de primer
                        uso </td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.7 Seca utensilios por escurrimiento o con secador limpio .</td>
                      <td class="text-center">SI=2</td>
                      <td class="text-center">
                        <select id="ii_7" name="coda4" class="form-control text-right">
                          <option value="0">0</option>
                          <option value="4">4</option>
                      </td>
                    ...
                    <tr>
                      <td>4.3 Utensillios en buen estado , limpio y protegidos .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>4.5 Paños y secadores limpio y desinfectados .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>4.8 Ausencia de vectores , roedores u otros animales o signos de su presencia ( excremento u
                        otros ).</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
