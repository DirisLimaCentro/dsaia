              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <table class="table  table-bordered table-condensed table-hover " style="width: 100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>1.2 Aspecto normal de pescados o mariscos y ausencia de parasitos ( QUISTES , LARVAS ).</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>1.3 Pescados y mariscos identificados por especie .</td>
                    ...
                    <tr>
                      <td>2.1 Aplica temperatura de frio (3° a - 18° C ).</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.2 Usa hielo de agua segura (proveedor ) (*)</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.3 Usa agua segura (0,5 ppm ) y fria para refrescar (*) </td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.4 Exhibe en bandejas de material sanitario y de facil limpieza.</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>2.6 Despacha con bolsas plasticas transparentes o blancas de primer uso .</td>
                      <td class="text-center">SI=2</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>4.4 Equipos y utensilios en buen estado y limpios .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>4.6 Paños , secadores en buen estado y limpios .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
                    ...
                    <tr>
                      <td>4.9 Ausencia de vectores , roedores u otros animales o signos de su presencia ( excremento u
                        otros ) .</td>
                      <td class="text-center">SI=4</td>
                      <td class="text-center">
