            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-download"></i> Ingresos <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">

                      <li><a href="compra.php">Compras</a></li>
                      <li><a href="ordencompra.php">Orden de Compra</a></li>
                      <li><a href="otrosingresos.php">Otros Ingresos</a></li>
                    </ul>
                    
                  </li>
                  <li><a><i class="fa fa-upload"></i> Salidas <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="salidas.php">Despacho</a></li>
                      
                    </ul>
                  </li>
                  <?php } ?>
                  <li><a><i class="fa fa-list"></i> Requerimientos <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="requerimientos.php">Registro</a></li>
                   ...
                   <li><a><i class="fa fa-file-pdf-o"></i> Reportes <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="rep_compras.php">Compras</a></li>    
                      <li><a href="rep_salidas.php">Salidas de Almacen</a></li>                  
                      <li><a href="rep_sinstock.php">Items sin stock</a></li>
                      <li><a href="rep_lotesxvencer.php">Lotes por vencer</a></li>
