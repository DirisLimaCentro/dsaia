...
Class Salida
{
	...
	public function registroSalidas($desde,$hasta,$id_empresa,$id_local,$id_personal,$id_catalogo)
	{
		...
		AND ig.fecha_salida<='".$hasta." 11:59 PM' ".$cri_emp.$cri_loc.$cri_per.$cri_cat."
	...
	public function insertar_($nombre,$nombre_comercial,$direccion,$ruc,$telefono_fijo,$ubigeo,$celular,$email,$web,$facebook)
	{
		...
		public function listar($sWhere,$sOrder,$sLimit)
		{
			...
			s.serie_documento,
			s.numero_documento,
			li.nombre local_ingreso,
			to_char(s.fecha_salida,'dd/mm/yyyy')::date as  fecha_salida,
			e.nombre as empresa,
			s.id_requerimiento,
