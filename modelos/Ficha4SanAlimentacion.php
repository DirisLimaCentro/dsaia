...
class Ficha
{
	...
	public function save(
		...
		$sql = "SELECT sp_crud_ficha_4_mercado(
		'$id_ficha',
		'$id_local',
		'$id_usuario',
	...
	{
		$sql = "UPDATE ficha_4_mercado SET estado=false WHERE id='$id'";
		return ejecutarConsulta($sql);
	}
	...
	{
		$sql = "UPDATE ficha_4_mercado SET estado=true WHERE id='$id'";
		return ejecutarConsulta($sql);
	}
