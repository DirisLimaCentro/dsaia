...
Class Ficha
{
	...
	public function save(
		...
		$sql="SELECT sp_crud_ficha_rabia(
	...
	public function mostrar($id)
	{
		...
		$sql="select f.id,f.id_entidad,f.id_persona,
		...
		de.distrito as distrito_empresa,
        ...
        dp.distrito as distrito_persona,
        vacuna_antirabica,
        vacuna_antitetanica,
        mordedura_ultimo,
        acudio_es,
        ...
        guia_sanitaria ,
        autoriza_correo,
        (select  array_to_json(array_agg( id_tipo_animal )) from ficha_rabia_especies where
         ficha_rabia_especies.id_ficha_rabia=f.id) as especies
		from ficha_rabia f
