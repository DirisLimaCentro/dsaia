...
order by 1,2    ";
	...
	public function save(
		...
		$sql="SELECT 
		sp_crud_header_ficha_fumigacion(
		'$id_ficha',
		'$id_local_destino',
		'$fecha_programada',
		'$hora_salida',
	...
	public function saveFichaDetalle(
		...
		$sql="SELECT sp_crud_body_ficha_fumigacion(
		'$id_ficha',
		'$id_ficha_detalle',
		'$lugar',
		'$direccion_ruta',
	...
	{
		$sql="select * from ficha_rutas_fumigacion_detalle
		where id_ficha_fumigacion='$id'
		order by id desc";
		return ejecutarConsulta($sql);
	}
	...
	public function listar($sWhere,$sOrder,$sLimit)
	{
		...
		$sql="
		select f.id  as \"f.id\",
		f.fecha_programada as \"f.fecha_programada\",
		f.id_local  as \"f.id_local\",
		l.nombre as \"l.nombre\",
		f.hora_salida as \"f.hora_salida\",

		f.id_usuario_crea as \"f.id_usuario_crea\",

		f.actividad as \"f.actividad\",
		f.hora_llegada as \"f.hora_llegada\",
		f.area as \"f.area\",
		f.organiza as \"f.organiza\",
		f.participa as \"f.participa\",
