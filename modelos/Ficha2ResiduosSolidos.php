...
Class Ficha
{
	...
	public function save(
		...
		$sql="SELECT sp_crud_ficha_2_residuos_solidos(
		'$accion',
		'$id_ficha',
		'$dato_ipress',
		'$dato_principal',	
    ...
    {
        $sql="UPDATE ficha_2_residuos_solidos SET estado=false    WHERE id='$id_ficha'";
        return ejecutarConsulta($sql);
    }
    ...
    {
        $sql="UPDATE ficha_2_residuos_solidos SET estado=true  WHERE id='$id_ficha'";
        return ejecutarConsulta($sql);
    }
...
i.codigo_unico, i.nombre_establecimiento,
i.id_tipo_ipress, itipo.descripcion tipo_ipress,
i.id_categoria_ipress, icate.descripcion categoria_ipress,
i.id_ubicacion_ubigeo, di.distrito as distrito_ipress,
 /* tm.fullname as servicio_a,
 


 f.servicio_a as servicio_a2,
 tm.fullname as servicio_a,*/

i.direccion as direccion_ipress, i.telefono as telefono_ipress, 
nombre_responsable_ipress, nombre_responsable_eess, nombre_evaluador, nombre_comercial , observacion ,
valoracion1 , valoracion2 , valoracion3 , valoracion4 , valoracion5 , valoracion6 , 
...
iii_2, iii_3, iii_4, iii_5, 

iiii_1, iiii_2, iiii_3, iiii_4, iiii_5,  iiii_6, iiii_7, iiii_8, iiii_9, 
/*
iiiii_1, iiiii_2, iiiii_3,*/

iiiiii_1, iiiiii_2, iiiiii_3, iiiiii_4,

total_puntaje ,  total_puntaje2 ,  total_puntaje3 ,  total_puntaje4 ,  total_puntaje5 ,  total_puntaje6 , 
p_1  ,  p_2 , p_3 , p_4  , p_5  , p_6    ,   p_7  , p_8  , p_9      ,   p_10    ,   p_11  , p_12  , p_13      , p_14    
  p_15 , p_16     ,   p_17    ,   p_18  , p_19  , p_20      , p_21   , p_22  , p_23   , 
      p_24      , p_25   , p_26  , p_27    , p_28   , p_29  , p_30  , m_5 ,m_6 ,m_7 ,m_8 ,
         
          m_2_5 ,m_2_6 ,m_2_7 ,m_2_8 ,
          
           m_3_1 ,m_5_1 ,m_5_2 ,m_5_3  , servicio_a , servicio_b ,  servicio_c ,  servicio_d



from ficha_2_residuos_solidos f
...
inner join tablas itipo on itipo.id_tipo=i.id_tipo_ipress and itipo.id_tabla='76'
 ...
 /* inner join tabla_empresas_operadoras tm on tm.id=f.servicio_a */
